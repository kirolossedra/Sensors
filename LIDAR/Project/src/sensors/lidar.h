...
struct Lidar
{
	...
	{       //Task 4 getting more optimal Point cloud by increasing resolution and discarding irrelavant points(hitting actor car) and by adding error(can't understand what sderr will do)
		...
		// To get higher resolution the circular incrementation which adds more rays
